  ...
  return (
    <div className="relative inline-block text-left">
      ...
      {menuOpen && ( // Render the dropdown menu only if menuOpen is true
        <div
          className="origin-top-right absolute  right-0 mt-2 w-56 z-10 rounded-[2vw] md:rounded-[0.5vw] text-white font-semibold shadow-lg bg-black border border-cyan-400 "
          role="menu"
