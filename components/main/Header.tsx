        ...
        <div className='flex space-x-[1vw]   items-center' >
          <Image src={logo} className='w-[15vw] md:w-[10vw]' alt='' />
            ...
            <div className=' hidden  md:flex space-x-[5vw] ' >
                <Link href='/VideoPage' ><p className=' text-[#FFFFFF] text-[1vw]' >Home</p></Link>
                <p className='text-[#FFFFFF] text-[1vw]'>Marketplace</p>
                <p className='text-[#FFFFFF] text-[1vw]'>Contact us</p>
            </div>
